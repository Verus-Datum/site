...
def upgrade() -> None:
    ...
    op.alter_column('listings', 'user_id',
               ...
               nullable=True)
    op.alter_column('listings', 'contact_method',
               existing_type=sa.VARCHAR(),
               nullable=True)
    op.alter_column('listings', 'is_public',
               existing_type=sa.BOOLEAN(),
               nullable=True)
    op.alter_column('listings', 'asking_price',
...
def downgrade() -> None:
    ...
    op.add_column('listings', sa.Column('longitude', sa.DOUBLE_PRECISION(precision=53), autoincrement=False, nullable=False))
    op.add_column('listings', sa.Column('address', sa.VARCHAR(), autoincrement=False, nullable=False))
    op.add_column('listings', sa.Column('name', sa.VARCHAR(), autoincrement=False, nullable=False))
    op.add_column('listings', sa.Column('profit_per_yr', sa.DOUBLE_PRECISION(precision=53), autoincrement=False, nullable=False))
    op.add_column('listings', sa.Column('market', sa.VARCHAR(), autoincrement=False, nullable=False))
    op.add_column('listings', sa.Column('latitude', sa.DOUBLE_PRECISION(precision=53), autoincrement=False, nullable=False))
    op.add_column('listings', sa.Column('revenue_per_yr', sa.DOUBLE_PRECISION(precision=53), autoincrement=False, nullable=False))
    op.add_column('listings', sa.Column('gross_per_yr', sa.DOUBLE_PRECISION(precision=53), autoincrement=False, nullable=False))
