    ...
    >
        ...
        <form method="POST" use:enhance onsubmit={step === 1 ? () => (step = 2) : handleSubmit} class="flex w-full flex-col gap-6">
            {#if step === 1}
                <Form.Field {form} name="businessName" class="flex w-full flex-col">
                    <Form.Control>
                        {#snippet children({ props })}<Form.Label class="text-sm font-medium">Business Name</Form.Label>
                            <Input disabled={creatingListing} {...props} bind:value={$formData.businessName} type="text" placeholder="ACME Inc." class="font-medium" />
                        {/snippet}
                    </Form.Control>
                </Form.Field>
                ...
                <Form.Field {form} name="industryMarket" class="flex w-full flex-col">
                    <Form.Control>
                        {#snippet children({ props })}<Form.Label class="text-sm font-medium">Industry / Market</Form.Label>
                            <Input disabled={creatingListing} {...props} bind:value={$formData.industryMarket} type="text" placeholder="Restaurant" class="font-medium" />
                        {/snippet}
                    </Form.Control>
                </Form.Field>
                ...
                <Form.Field {form} name="isPublic" class="flex w-full flex-col">
                    <Form.Control>
                        {#snippet children({ props })}<div class="flex flex-row items-center gap-2">
                ...
                <Form.Field {form} name="isOnline" class="flex w-full flex-col">
                    <Form.Control>
                        {#snippet children({ props })}<div class="flex flex-row items-center gap-2">
                            <Checkbox {...props} bind:checked={$formData.isOnline} />
                ...
                <div class="ml-auto">
                    <Form.Button disabled={creatingListing} class="w-auto">Next</Form.Button>
                </div>
            {:else if step === 2}
                <div class="grid grid-cols-2 grid-rows-2 gap-6">
                    <Form.Field {form} name="askingPrice"><Form.Control>
                        {#snippet children({ props })}<Form.Label class="text-sm font-medium">Asking Price ($)</Form.Label>
                            <Input disabled={creatingListing} {...props} type="number" placeholder="$450,000" bind:value={$formData.askingPrice} class="font-medium" />
                        {/snippet}
                    </Form.Control></Form.Field>

                    <Form.Field {form} name="annualRevenue"><Form.Control>
                        {#snippet children({ props })}<Form.Label class="text-sm font-medium">Annual Revenue ($)</Form.Label>
                            <Input disabled={creatingListing} {...props} type="number" placeholder="$850,000" bind:value={$formData.annualRevenue} class="font-medium" />
                        {/snippet}
                    </Form.Control></Form.Field>

                    <Form.Field {form} name="annualGross"><Form.Control>
                        {#snippet children({ props })}<Form.Label class="text-sm font-medium">Annual Gross ($)</Form.Label>
                            <Input disabled={creatingListing} {...props} type="number" placeholder="$550,000" bind:value={$formData.annualGross} class="font-medium" />
                        {/snippet}
                    </Form.Control></Form.Field>

                    <Form.Field {form} name="annualProfit"><Form.Control>
                        {#snippet children({ props })}<Form.Label class="text-sm font-medium">Annual Profit ($)</Form.Label>
                            <Input disabled={creatingListing} {...props} type="number" placeholder="$125,000" bind:value={$formData.annualProfit} class="font-medium" />
                        {/snippet}
                    </Form.Control></Form.Field>
                </div>
