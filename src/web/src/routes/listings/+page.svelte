<script lang="ts">
	...
	function clearFilters() {
		...
		filters.askingPrice = [getLowestAskingPrice(originalBusinesses), getHighestAskingPrice(originalBusinesses)];
		filters.grossYearly = [getLowestGross(originalBusinesses), getHighestGross(originalBusinesses)];
		filters.revenueYearly = [getLowestRevenue(originalBusinesses), getHighestRevenue(originalBusinesses)];
		filters.profitYearly = [getLowestProfit(originalBusinesses), getHighestProfit(originalBusinesses)];
	...
	<section class="flex flex-row w-full gap-6">
        <aside class="flex flex-col w-96">
            <h1 class="w-full flex flex-row justify-between font-medium text-muted-foreground items-center border-b py-5">
                Filter By
                <button onclick={clearFilters} class="text-primary text-sm">
                   Clear
                </button>
            </h1>
            ...
            <div class="flex flex-row gap-2 items-center py-5 border-b">
                <Checkbox class="border-border" id="public" bind:checked={isPublic} onCheckedChange={handlePublicCheck} />
            ...
            <Accordion.Root type="multiple">
                <Accordion.Item value="business-type">
                    <Accordion.Trigger class="font-medium text-muted-foreground">Business Type</Accordion.Trigger>
                    <Accordion.Content>
                        <div class="flex flex-row gap-2 items-center py-1">
                            <Checkbox class="border-border" id="online" checked={onlineChecked} onCheckedChange={handleOnlineCheck} />
                            <label class="text-sm font-medium text-muted-foreground" for="online">
                                Online
                            </label>
                        </div>
                        <div class="flex flex-row gap-2 items-center py-1">
                            <Checkbox class="border-border" id="physical" checked={physicalChecked} onCheckedChange={handlePhysicalCheck} />
            ...
            <Accordion.Root type="multiple">
                <Accordion.Item value="contact-method">
                    ...
                    <Accordion.Content>
                        <div class="flex flex-row gap-2 items-center py-1">
                            <Checkbox class="border-border" id="broker" checked={brokerChecked} onCheckedChange={handleBrokerCheck} />
                            <label class="text-sm font-medium text-muted-foreground" for="broker">
                                Broker
                            </label>
                        </div>
                        <div class="flex flex-row gap-2 items-center py-1">
                            <Checkbox class="border-border" id="direct-owner" checked={directOwnerChecked} onCheckedChange={handleDirectOwnerCheck} />
            ...
            <Accordion.Root type="multiple">
                <Accordion.Item value="asking-price">
                    ...
                    <Accordion.Content class="w-full">
                        ...
                        <Slider step={10000} min={getLowestAskingPrice(businesses)} max={getHighestAskingPrice(businesses)} type="multiple" class="py-2 w-[92.5%] mx-auto" bind:value={filters.askingPrice} />
                    </Accordion.Content>
                </Accordion.Item>
            </Accordion.Root>
            ...
            <Accordion.Root type="multiple">
                <Accordion.Item value="yearly-revenue">
                    ...
                    <Accordion.Content>
                        ...
                        <Slider step={10000} min={getLowestRevenue(businesses)} max={getHighestRevenue(businesses)} type="multiple" class="py-2 w-[92.5%] mx-auto" bind:value={filters.revenueYearly} />
                    </Accordion.Content>
                </Accordion.Item>
            </Accordion.Root>
            ...
            <Accordion.Root type="multiple">
                <Accordion.Item value="yearly-gross">
                    ...
                    <Accordion.Content>
                        ...
                        <Slider step={10000} min={getLowestGross(businesses)} max={getHighestGross(businesses)} type="multiple" class="py-2 w-[92.5%] mx-auto" bind:value={filters.grossYearly} />
                    </Accordion.Content>
                </Accordion.Item>
            </Accordion.Root>
            ...
            <Accordion.Root type="multiple">
                <Accordion.Item value="yearly-profit">
                    ...
                    <Accordion.Content>
                        ...
                        <Slider step={10000} min={getLowestProfit(businesses)} max={getHighestProfit(businesses)} type="multiple" class="py-2 w-[92.5%] mx-auto" bind:value={filters.profitYearly} />
                    </Accordion.Content>
                </Accordion.Item>
            </Accordion.Root>
        </aside>
